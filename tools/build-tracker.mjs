...
setup.getRange("A2:D13").values = [
  ...
  ["Make GitHub repository public", "You", "Done", "Public brand repository: davideskoundosincome/tidy-small-spaces"],
  ["Publish GitHub Pages site", "You + Codex", "Done", "Live: davideskoundosincome.github.io/tidy-small-spaces/"],
