...
setup.getRange("A2:D13").values = [
  ...
  ["Create Pinterest business account", "You", "Not started", "Use US-English profile copy"],
  ["Create public GitHub repository", "You + Codex", "Not started", "Publish this starter site with GitHub Pages"],
  ["Publish GitHub Pages site", "You + Codex", "Not started", "Keep the github.io URL until $30 earned"],
  ["Add Pinterest profile link to site", "Codex", "Blocked", "Needs public profile URL"],
