...
setup.getRange("A2:D13").values = [
  ...
  ["Make GitHub repository public", "You", "Done", "Public brand repository: tidysmallspaces/tidysmallspaces.github.io"],
  ["Publish GitHub Pages site", "You + Codex", "Done", "Live: tidysmallspaces.github.io/"],
